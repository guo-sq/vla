...
处理的数据集数量: 30
总 episode 数: 20,008
总 frame 数: 23,407,274
总时长: 216.73 小时 (780242 秒)
机器人类型: ALOHA_ROBOCHALLENGE, ARX5_SINGLE_ARM_ROBOCHALLENGE, FRANKA_SINGLE_ARM_ROBOCHALLENGE, UR5_SINGLE_ARM_ROBOCHALLENGE
"""
...
REPO_ID = robochallenge  # galaxea + agibotworld_alpha_lerobot + aloha + galaxea + intern_a1_real + rdt + rhos_ai_gm100 + robocoin
