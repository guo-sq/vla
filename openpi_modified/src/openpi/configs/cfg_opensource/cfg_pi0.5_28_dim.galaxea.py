...
处理的数据集数量: 224
    总 episode 数: 19,203
    总 frame 数: 25,168,421
    总时长: 466.08 小时 (1677895 秒)
    机器人类型: r1lite, r1pro
"""

DEBUG_MODE = False

TASK_NAME = "cfg_pi0.5_28_dim.galaxea"
...
REPO_ID = galaxea  # galaxea + agibotworld_alpha_lerobot + aloha + galaxea + intern_a1_real + rdt + rhos_ai_gm100 + robocoin
