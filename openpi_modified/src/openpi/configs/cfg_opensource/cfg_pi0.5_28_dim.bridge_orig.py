...
TASK_NAME = "cfg_pi0.5_28_dim.bridge_orig"
...
# TODO(heyuan): get the actual target action dim for bridge_orig dataset automatically by meta in repo type
# TODO(heyuan): save the image in same path as json files
...
from openpi.configs.dataset_config.bridge_orig import REPO_ID as bridge_orig, ROOT_DIR

REPO_ID = bridge_orig  # galaxea + agibotworld_alpha_lerobot + aloha + galaxea + intern_a1_real + rdt + rhos_ai_gm100 + robocoin
...
test_cfg = TestConfig(
    ...
    num_workers=0,
    eval_split="val",
    vis_dir="checkpoints/cfg_pi0.5_28_dim.bridge_orig/cfg_pi0.5_28_dim.bridge_orig_exp/test_results/manual",
)