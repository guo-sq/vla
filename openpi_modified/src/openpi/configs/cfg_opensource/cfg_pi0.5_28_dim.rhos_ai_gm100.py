...
TASK_NAME = "cfg_pi0.5_28_dim.rhos_ai_gm100"
EXP_NAME = TASK_NAME + "_exp"
ASSET_ID = "20260207"

# Dataset settings
ROOT_DIR = "/mnt/"
ACTION_SEQUENCE_KEYS = ("action.arm.position", "action.effector.position")
...
REPO_ID = rhos_ai_gm100  # galaxea + agibotworld_alpha_lerobot + aloha + galaxea + intern_a1_real + rdt + rhos_ai_gm100 + robocoin
