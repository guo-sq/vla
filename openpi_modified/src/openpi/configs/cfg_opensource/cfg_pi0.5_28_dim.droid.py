...
"""
    处理的数据集数量: 1
    总 episode 数: 95,600
    总 frame 数: 27,612,581
    总时长: 511.34 小时 (1840839 秒)
    机器人类型: DROID
"""

DEBUG_MODE = False

TASK_NAME = "cfg_pi0.5_28_dim.droid_test"
EXP_NAME = TASK_NAME + "_exp"
ASSET_ID = "20260215"

# Dataset settings
ROOT_DIR = "/mnt/"
ACTION_SEQUENCE_KEYS = ("action", "action.original")
...
os.system("ls -l /mnt")
os.system("ls -l /mnt/workspace")
os.system("ls -l /mnt/data")

REPO_ID = (
    droid  # galaxea + agibotworld_alpha_lerobot + aloha + galaxea + intern_a1_real + rdt + rhos_ai_gm100 + robocoin
)
