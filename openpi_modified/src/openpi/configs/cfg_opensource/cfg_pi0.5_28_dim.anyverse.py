...
处理的数据集数量: 1355
总 episode 数: 26,774
总 frame 数: 42,005,440
总时长: 388.94 小时 (1400181 秒)
机器人类型: arxx5_bimanual, bi_piper_follower
...
TASK_NAME = "align_test.anyverse"
EXP_NAME = TASK_NAME + "_exp"
ASSET_ID = "20260212"

ROOT_DIR = "/mnt/"

# from openpi.configs.dataset_config.anyverse import REPO_ID, ROOT_DIR
...
REPO_ID = fold_box + fold_clothes + insert_tube + pack_socks + pick_place + pour_water + seatbelt
