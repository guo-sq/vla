...
TASK_NAME = "cfg_pi0.5_28_dim.bridge_v2"
...
# from openpi.configs.dataset_config.droid import REPO_ID as droid
from openpi.configs.dataset_config.bridge_v2 import REPO_ID as bridge_v2, ROOT_DIR

REPO_ID = bridge_v2  # galaxea + agibotworld_alpha_lerobot + aloha + galaxea + intern_a1_real + rdt + rhos_ai_gm100 + robocoin
