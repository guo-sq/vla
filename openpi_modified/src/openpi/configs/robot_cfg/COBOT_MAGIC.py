...
COBOT_DECOUPLED_MAGIC = RobotInfo(
    # has_eef=True,
...
SONGLING_SELFCOLLECT = RobotInfo(
    # has_eef=False,
    state_meta_source_dict={
        "left_joint_map_dict": "observation.state.arm.position",
        "left_gripper_map_dict": "observation.state.effector.position",
        "right_joint_map_dict": "observation.state.arm.position",
        "right_gripper_map_dict": "observation.state.effector.position",
    },
    action_meta_source_dict={
        "left_joint_map_dict": "action.arm.position",
        "left_gripper_map_dict": "action.effector.position",
        "right_joint_map_dict": "action.arm.position",
        "right_gripper_map_dict": "action.effector.position",
    },
    name_mapping_dict=dict(
        left_joint_map_dict={
            "left_arm_0": AlignActionDim.LEFT_ALIGN_JOINT_1.value,
            "left_arm_1": AlignActionDim.LEFT_ALIGN_JOINT_2.value,
            "left_arm_2": AlignActionDim.LEFT_ALIGN_JOINT_4.value,
            "left_arm_3": AlignActionDim.LEFT_ALIGN_JOINT_5.value,
            "left_arm_4": AlignActionDim.LEFT_ALIGN_JOINT_6.value,
            "left_arm_5": AlignActionDim.LEFT_ALIGN_JOINT_7.value,
        },
        left_gripper_map_dict={
        ...
        right_joint_map_dict={
            ...
            "right_arm_2": AlignActionDim.RIGHT_ALIGN_JOINT_4.value,
            "right_arm_3": AlignActionDim.RIGHT_ALIGN_JOINT_5.value,
            "right_arm_4": AlignActionDim.RIGHT_ALIGN_JOINT_6.value,
            "right_arm_5": AlignActionDim.RIGHT_ALIGN_JOINT_7.value,
        },
        right_gripper_map_dict={
