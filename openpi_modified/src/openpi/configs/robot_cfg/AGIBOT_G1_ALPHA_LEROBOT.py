...
# refer to AI-ModelScope/AgiBotWorld-Alpha/scripts/convert_to_lerobot.py
AGIBOT_G1_ALPHA_LEROBOT = RobotInfo(
    # has_eef=True,
...
INTERNDATA_GENIE_1 = RobotInfo(
    # hf_dataset_mapping_dict={
    #     "actions.joint.position": "action",
    #     "observation.states.joint.position": "observation.state",
    #     "actions.effector.position": "gripper.action",
    #     "observation.states.effector.position": "observation.gripper.state",
    # },
    state_meta_source_dict={
        "left_joint_map_dict": "observation.states.joint.position",
        "left_gripper_map_dict": "observation.states.effector.position",
        "right_joint_map_dict": "observation.states.joint.position",
        "right_gripper_map_dict": "observation.states.effector.position",
    },
    action_meta_source_dict={
        "left_joint_map_dict": "actions.joint.position",
        "left_gripper_map_dict": "actions.effector.position",
        "right_joint_map_dict": "actions.joint.position",
        "right_gripper_map_dict": "actions.effector.position",
    },
    name_mapping_dict=dict(
        left_joint_map_dict={
            "left_arm_0": AlignActionDim.LEFT_ALIGN_JOINT_1.value,
            "left_arm_1": AlignActionDim.LEFT_ALIGN_JOINT_2.value,
            "left_arm_2": AlignActionDim.LEFT_ALIGN_JOINT_3.value,
            "left_arm_3": AlignActionDim.LEFT_ALIGN_JOINT_4.value,
            "left_arm_4": AlignActionDim.LEFT_ALIGN_JOINT_5.value,
            "left_arm_5": AlignActionDim.LEFT_ALIGN_JOINT_6.value,
            "left_arm_6": AlignActionDim.LEFT_ALIGN_JOINT_7.value,
        },
        left_gripper_map_dict={
            "left_gripper": AlignActionDim.LEFT_ALIGN_GRIPPER.value,
        },
        right_joint_map_dict={
            "right_arm_0": AlignActionDim.RIGHT_ALIGN_JOINT_1.value,
            "right_arm_1": AlignActionDim.RIGHT_ALIGN_JOINT_2.value,
            "right_arm_2": AlignActionDim.RIGHT_ALIGN_JOINT_3.value,
            "right_arm_3": AlignActionDim.RIGHT_ALIGN_JOINT_4.value,
            "right_arm_4": AlignActionDim.RIGHT_ALIGN_JOINT_5.value,
            "right_arm_5": AlignActionDim.RIGHT_ALIGN_JOINT_6.value,
            "right_arm_6": AlignActionDim.RIGHT_ALIGN_JOINT_7.value,
        },
        right_gripper_map_dict={
            "right_gripper": AlignActionDim.RIGHT_ALIGN_GRIPPER.value,
        },
