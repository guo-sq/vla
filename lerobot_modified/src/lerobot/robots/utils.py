...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "arxx5":
        from .arx_x5_python import ArxX5

        return ArxX5(config)
    elif config.type == "arxx5_bimanual":
        from .arx_x5_python import ArxX5Bimanual

        return ArxX5Bimanual(config)
