...
def init_logging(
    ...
    def custom_format(record: logging.LogRecord) -> str:
        ...
        # Append exception traceback when ``logging.error(..., exc_info=True)``
        # was used. Without this, exc_info silently disappears and operators
        # see only the exception message, not its origin.
        if record.exc_info:
...
def say(text: str, blocking: bool = False):
    ...
    # Normalize Unicode (NFC) so TTS receives consistent graphemes; avoid encoding quirks.
