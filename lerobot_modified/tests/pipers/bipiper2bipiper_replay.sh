...
for episode_id in {0..35}; do
  ...
  python -m lerobot.replay --robot.type=bi_piper_follower \
      ...
      --robot.cameras="{head: {type: opencv, index_or_path: 12, width: 640, height: 480, fps: 30}, right_wrist: {type: opencv, index_or_path: 5, width: 640, height: 480, fps: 30}, left_wrist: {type: opencv, index_or_path: 10, width: 640, height: 480, fps: 30}}"  \
      --dataset.repo_id=1128_bi/record.xiangqi.bipiper.v1212.1 \
